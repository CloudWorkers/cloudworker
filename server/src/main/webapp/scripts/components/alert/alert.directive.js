        ...
        return {
            ...
            controller: ['$scope',
                function($scope) {
                    ...
                    var cleanHttpErrorListener = $rootScope.$on('cloudworkerApp.httpError', function (event, httpResponse) {
                        var i;
                        ...
                        switch (httpResponse.status) {
                            ...
                            case 400:
                                var errorHeader = httpResponse.headers('X-cloudworkerApp-error');
                                var entityKey = httpResponse.headers('X-cloudworkerApp-params');
                                if (errorHeader) {
