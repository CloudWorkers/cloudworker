...
import com.cloudworkers.cloudworker.domain.Authority;
import com.cloudworkers.cloudworker.domain.User;
import com.cloudworkers.cloudworker.repository.AuthorityRepository;
import com.cloudworkers.cloudworker.repository.UserRepository;
import com.cloudworkers.cloudworker.security.AuthoritiesConstants;
import com.cloudworkers.cloudworker.service.MailService;
import com.cloudworkers.cloudworker.service.UserService;
import com.cloudworkers.cloudworker.web.rest.dto.ManagedUserDTO;
import com.cloudworkers.cloudworker.web.rest.dto.UserDTO;
    ...
    public ResponseEntity<?> createUser(@RequestBody ManagedUserDTO managedUserDTO, HttpServletRequest request) throws URISyntaxException {
        ...
        if (userRepository.findOneByLogin(managedUserDTO.getLogin()).isPresent()) {
            ...
            return ResponseEntity.created(new URI("/api/users/" + newUser.getLogin()))
                .headers(HeaderUtil.createAlert( "An user is created with identifier "+newUser.getLogin(), newUser.getLogin()))
                .body(newUser);
        }
    }
